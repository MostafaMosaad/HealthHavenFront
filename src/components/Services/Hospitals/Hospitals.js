      ...
      <Container>
        <Row>
          ...
          <Row className={style["body"]}>
            <h4>
              We are proud to have a number of prestigious hospitals as our
              clients. By choosing to partner with us, these hospitals have made
              it possible for patients to enjoy special discounts when seeking
              medical treatment. These hospitals are renowned for their high
              standards of care and state-of-the-art facilities, and we are
              thrilled to offer our clients the opportunity to receive
              top-quality medical care at a discounted rate.
            </h4>
          </Row>
          <Row>
            <Swiper
